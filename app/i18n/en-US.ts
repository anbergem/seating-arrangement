const messages = {
  ...
  seating: {
    ...
    diameter: "Diameter",
    emptyPlan: "No tables yet. Add one to start the seating plan.",
    ...
    noSelection: "Choose a seat on the plan to see its table here.",
    ...
    seatPresent: "Chair",
    seatPresentFor: "Chair at {{place}}",
    seatRemoved: "Chair taken away",
    seatRestored: "Chair put back",
    seatTakenAway: "Taken away to make room for another table.",
